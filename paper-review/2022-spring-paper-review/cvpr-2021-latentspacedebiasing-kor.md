...
![속성(안경)과 레이블(모자)간에 상관관계가 존재할 수 있다.](../../.gitbook/assets/2022spring/61/correlated.png)
...
![속성(안경)과 레이블(모자)의 상관관계를 제거한 모습](../../.gitbook/assets/2022spring/61/augmentation_overview.png)
