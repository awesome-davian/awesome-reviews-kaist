...
- Both shape mapper and appearance mapper are 2-layer MLP with ReLU activation. The channel size is 128 (input), &rarr; 256 (hidden), &rarr; 128 (output) for both mapers.
