...
Undistorted normalized pixel coordinate $$(n'_x, n'_y)$$ converted from pixel coordinate $$(p_x, p_y)$$ can be obtained using the 4th order radial distortion model as you can see in the following equations.
